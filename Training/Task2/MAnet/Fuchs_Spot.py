...
### 设置参数
images_file = './data/2. Segmentation of Myopic Maculopathy Plus Lesions/3. Fuchs Spot/1. Images/1. Training Set'  # 训练图像路径
gt_file = './data/2. Segmentation of Myopic Maculopathy Plus Lesions/3. Fuchs Spot/2. Groundtruths/1. Training Set'
...
#             print(abc)
    ...
    plot_training_progress(logs, save_path='./logs/training_progress.png', title='Fuchs Spot Training Progress')
